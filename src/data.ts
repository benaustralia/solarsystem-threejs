...
export const defRadius = () => innerHeight > innerWidth ? AU * 6 : AU * 4;
...
export const PINFO: Record<string, string> = {
  ...
  Moon:    "Earth's natural satellite \u00b7 27-day orbit",
  Io:      'Most volcanically active body in solar system',
  Europa:  'Ice shell over subsurface ocean',
  Ganymede:'Largest moon in solar system',
  Callisto:'Most heavily cratered object known',
  Titan:   'Only moon with a dense atmosphere',
...
export const PLANETS: PlanetDef[] = [
  ...
  planet('Mars', 0.440, 'mars', 0.093, 1.85, 49.6, 286.5, 1.881,
    2.2, 95, 0.532*ER, 1.524*AU*TOS, 0.014, [
      moon('Phobos', 'generic', 0.220, 0.4, 5.0, 0.040*ER, 1.5),
      moon('Deimos', 'generic', 0.090, 0.3, 7.5, 0.030*ER, 2.5),
    ]),
  planet('Jupiter', 0.054, 'jupiter', 0.049, 1.30, 100.5, 273.9, 11.860,
    10, 145, 11.210*ER, 5.203*AU*TOS, 0.036, [
      ...
      moon('Ganymede', 'moon', 0.045, 1.2, 27, 0.413*ER, 29),
      moon('Callisto', 'moon', 0.020, 1.1, 34, 0.378*ER, 51),
    ]),
  planet('Saturn', 0.467, 'saturn', 0.057, 2.49, 113.6, 339.4, 29.460,
    8.5, 200, 9.449*ER, 9.537*AU*TOS, 0.034, [
      moon('Mimas', 'moon', 0.130, 0.4, 13, 0.031*ER, 8),
      moon('Enceladus', 'moon', 0.090, 0.5, 16, 0.040*ER, 11),
      moon('Tethys', 'moon', 0.060, 0.7, 19, 0.084*ER, 14),
      moon('Dione', 'moon', 0.043, 0.7, 23, 0.088*ER, 18),
      moon('Rhea', 'moon', 0.029, 0.8, 27, 0.120*ER, 24),
      moon('Titan', 'titan', 0.012, 1.3, 34, 0.404*ER, 57),
      moon('Iapetus', 'generic', 0.005, 0.7, 42, 0.116*ER, 147),
      moon('Hyperion', 'generic', 0.014, 0.5, 52, 0.043*ER, 75),
      moon('Phoebe', 'generic', 0.003, 0.4, 80, 0.033*ER, 350),
    ]),
  planet('Uranus', 1.706, 'uranus', 0.046, 0.77, 74.0, 96.5, 84.010,
    5.5, 260, 4.007*ER, 19.19*AU*TOS, -0.021, [
      moon('Miranda', 'moon', 0.100, 0.40, 9, 0.036*ER, 5),
      moon('Ariel', 'moon', 0.060, 0.55, 12, 0.091*ER, 8),
      moon('Umbriel', 'moon', 0.040, 0.55, 15, 0.092*ER, 11),
      moon('Titania', 'moon', 0.025, 0.70, 19, 0.124*ER, 18),
      moon('Oberon', 'moon', 0.018, 0.65, 23, 0.119*ER, 23),
    ]),
  planet('Neptune', 0.494, 'neptune', 0.010, 1.77, 131.8, 273.2, 164.800,
    5.0, 320, 3.883*ER, 30.07*AU*TOS, 0.022, [
      moon('Triton', 'moon', 0.050, 0.8, 12, 0.212*ER, 14),
      moon('Nereid', 'generic', 0.009, 0.4, 18, 0.027*ER, 110),
      moon('Proteus', 'generic', 0.080, 0.4, 10, 0.033*ER, 8),
    ]),
];
